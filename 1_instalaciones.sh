...
#	    fi
	    ...
	    if [ $? -ne 0 ]								#si esta dara 1 asi que te dira que esta instalado y no hara nada 
	        ...
	        then
	            ...
	            sudo apt-get install gnupg		#te instalara el paquete
	    ...
	    if [ $? -ne 0 ]								#si esta dara 1 asi que te dira que esta instalado y no hara nada 
	        ...
	        then
	            ...
	            sudo apt-get install lsb-release		#te instalara el paquete
...
#	dpkg -s openvpn &> /dev/null
	    ...
	    if [ $? -ne 0 ]								#si esta dara 1 asi que te dira que esta instalado y no hara nada 
	        ...
	        then
	            ...
	            sudo apt-get install ca-certificates		#te instalara el paquete
	    ...
	    if [ $? -ne 0 ]								#si esta dara 1 asi que te dira que esta instalado y no hara nada 
	        ...
	        then
	            ...
	            sudo apt-get install containerd.io		#te instalara el paquete
	    ...
	    if [ $? -ne 0 ]								#si esta dara 1 asi que te dira que esta instalado y no hara nada 
	        ...
	        then
	            ...
	            sudo apt-get install docker-ce-cli		#te instalara el paquete
